...
WebSocket protocol types shared between the proxy server and worker daemon in the [ModelRelay](https://github.com/ericflo/modelrelay) system.
...
See the [main repository](https://github.com/ericflo/modelrelay) for full documentation and usage examples.
