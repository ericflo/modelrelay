...
- Setup wizard Step 8: "Make it persistent" — platform-aware walkthrough for systemd (Linux), launchd (macOS), and Windows Service setup with copy-paste commands (#234)
